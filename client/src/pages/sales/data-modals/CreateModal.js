...
import { CreateSale } from "../../../store/actions/all-actions/SalesAction";
import io from "socket.io-client";
import { BASE_URL } from "../../../components/config/BASE_URL";
import { dptOption } from "../../../components/config/SelectFieldOptions";
...
const CreateModal = (props) => {
  ...
  // Sales create function
  const createSalesHandler = () => {
    let data = {
      amount: amount,
    ...
    if (data.amount !== 0 && data.description !== "" && data.date !== "") {
      dispatch(CreateSale(data, closeModal));
    } else {
        ...
        <MDBModalDialog centered size="lg fullscreen-md-down">
          <MDBModalContent>
            ...
            <MDBModalFooter>
              ...
              <MDBBtn onClick={createSalesHandler}>Create</MDBBtn>
            </MDBModalFooter>
          </MDBModalContent>
        </MDBModalDialog>
      </MDBModal>
